...
Слэш в конце пути источника говорит о том, что НЕ нужно создавать дополнительный каталог в каталоге назначения (то есть копируется содержимое каталога за слешем)
...
Выполнил все настройки, и произвел необходимые операции под Windows. Сделал еще раз полный образ диска с Windows.
