...
Слэш в конце пути источника говорит о том, что НЕ нужно создавать дополнительный каталог в каталоге назначения (то есть копируется содержимое каталога источника, то что за последним слешем)

Если слэша нет в конце пути источника, то нужно создавать копируемый каталог (то есть копируется каталог источник в каталог назначения)
...
Это самый интересный режим, потому как позволят значительно уменьшить время клонирования больших разделов или дисков.
